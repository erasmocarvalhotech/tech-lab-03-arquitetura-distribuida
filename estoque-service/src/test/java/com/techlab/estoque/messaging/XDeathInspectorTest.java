...
class XDeathInspectorTest {
    ...
    void semHeaderXDeath_retornaZero() {
        ...
        long ciclos = inspector.countCiclosDelayed(message, "mb-techlab-stock-queue-product-changed-delayed");
    ...
    void comEntradaExpiredNaFilaDelayed_retornaCount() {
        ...
        properties.setHeader("x-death", List.of(
                Map.of("queue", "mb-techlab-stock-queue-product-changed-delayed", "reason", "expired", "count", 2L)
        ));
    ...
    void comEntradaRejectedEmVezDeExpired_ignoraERetornaZero() {
        MessageProperties properties = new MessageProperties();
        properties.setHeader("x-death", List.of(
                Map.of("queue", "mb-techlab-stock-queue-product-changed-delayed", "reason", "rejected", "count", 3L)
        ));
        Message message = new Message(new byte[0], properties);
